...
$adminmenu[1] = array(
	...
	'subnav' => array(
		...
		array('name' => '商品详情列表', 'menumark' => 'product_detail', 'url' => 'admin.php?mod=product_detail&state=1'),
		array('name' => '画布列表', 'menumark' => 'canvas', 'url' => 'admin.php?mod=canvas&state=1'),
		array('name' => '商品分类', 'menumark' => 'category', 'url' => 'admin.php?mod=category'),
		array('name' => 'IP管理', 'menumark' => 'brand', 'url' => 'admin.php?mod=brand'),
		array('name' => 'IP图片管理', 'menumark' => 'brand_pic', 'url' => 'admin.php?mod=brand_pic'),
		array('name' => '图片评论管理', 'menumark' => 'brand_comment', 'url' => 'admin.php?mod=brand_comment'),
		...
		array('name' => '优 惠 券', 'menumark' => 'quan', 'url' => 'admin.php?mod=quan'),
		array('name' => '促销活动', 'menumark' => 'huodong', 'url' => 'admin.php?mod=huodong'),
		array('name' => '效果图列表', 'menumark' => 'design', 'url' => 'admin.php?mod=design')
	)
);
$adminmenu[3] = array(
	'headnav' => '交易中心',
