...
function wechat_jspay($order_id) {
	...
	$ojson = file_get_contents("https://api.weixin.qq.com/sns/oauth2/access_token?appid={$wechat_config['appid']}&secret={$wechat_config['wechat_appsecret']}&code={$_GET['code']}&grant_type=authorization_code");
